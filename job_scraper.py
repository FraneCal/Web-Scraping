...
def get_url(position, page):
    template = "https://de.indeed.com/jobs?q={}&start={}"
    url = template.format(position, page * 15)  # Assuming 10 jobs per page
    return url
...
url = get_url('cloud engineer', 0)  # Start with the first page
